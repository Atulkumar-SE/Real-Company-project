...
const Partners = () => {
  return (
    <div>
      {/* --------------Hero------------------- */}
      <div className="Partner_Hero relative w-[100%] h-[100vh] bg-center flex justify-center items-center">
        <div className=" w-[85%] m-auto text-white sm:float-left">
          <h1 className=" text-[2.5rem] sm:text-[5.5rem]  font-semibold">Nexus Alliance</h1>
      ...
      <div className="w-[85%] flex-col my-[5rem] m-auto grid  gap-[5rem]">
        ...
        <div className="grid gap-10">
          <div>
            <h5 className="text-[#047FCC] text-[1.5rem] font-semibold ">
              Technology Partners
            </h5>
            <div className="">
              <PartnerBrandCard />
