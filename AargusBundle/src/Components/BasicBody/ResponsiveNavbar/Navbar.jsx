...
const closeMobileMenu = () => {
  ...
  return (
    <nav className="zIndex bg-[#fff] w-full  sticky top-0">
      ...
      <ul
        className={` zIndex md:hidden bg-white absolute w-full  top-[5rem] py-3 pl-4 duration-300 ${
          open ? "left-0" : "left-[-100%]"
        }`}
      >
        <li className="py-3 px-3 "> <Link to="/" onClick={closeMobileMenu}>Home</Link></li>

        <Navliks closeMobileMenu={closeMobileMenu}/>
