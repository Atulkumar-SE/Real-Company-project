      ...
      {links.map((NavItem) => (
        <div key={NavItem.name}>
          <div className="px-3 py-2 text-left md:cursor-pointer group ">
            ...
            {NavItem.submenu && (
              <div>
                <div className="Position zIndex absolute top-[4.5rem] rounded-lg  hidden group-hover:md:block  hover:md:block animate-[pulse_1s]">
                    ...
                    >
                      {mlinks.sublink.map((mlink) => (
                        <li className="py-1 pl-14">
                          <Link to={mlink.path} className="hover:text-blue-500">
                            {mlink.name}
                          </Link>
                        </li>
                      ))}
